...
/**
 * Web 错误响应自动装配：全局异常处理、Spring Security 401/403 与配置驱动的异常消息来源。
 *
 * <p>traceId 过滤器不在这里，而在 {@code toolkit-trace} 的
 * {@code io.github.youngerier.support.trace.autoconfigure.TraceAutoConfiguration}，
 * 这样只引入 trace 模块的使用方也能自动获得过滤器。
 */
@AutoConfiguration
